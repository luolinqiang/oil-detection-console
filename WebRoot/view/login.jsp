...
<div id="login">
    <%--<div class="ribbon" style="background-image:url(plug-in/login/images/pass_.png);"></div>--%>
    <div class="inner">
        <div class="logo">
            <%--<img src="plug-in/login/images/pick_bg.jpg"/>--%>
        </div>
        <div class="formLogin">
            <form name="formLogin" id="formLogin" action="loginController.do?login" check="checkuser.do" method="post">
                <div class="tip">
                    <input class="userName" name="email" type="text" id="email" value='admin@qq.com' title="用户名"
                           iscookie="true" nullmsg="请输入用户名!"/>
                </div>
                <div class="tip">
                    <input class="password" name="pwd" type="password" value='654321' id="pwd" title="密码"
                           nullmsg="请输入密码!"/>
                </div>
