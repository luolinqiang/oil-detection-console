...
<div id="edit-win" class="easyui-dialog" title="" data-options="closed:true,iconCls:'icon-save',modal:true"
    ...
    <form id="editForm" class="ui-form" method="post" enctype="multipart/form-data">
        ...
        <div class="ui-edit">
            ...
            <div class="fitem">
                <label>类型（1：banner 2：直营专区 3：厂商报价 4：外链）</label>
                <input name="type" type="text" maxlength="" class="easyui-validatebox" data-options=""
                       missingMessage="请填写类型（1：banner 2：直营专区 3：厂商报价 4：外链）">
            </div>
            <div class="fitem">
                <label>文件</label>
